...
export default function Hero() {
  return (
    <div className="w-full relative">
      ...
      <Image
        className="object-cover w-full h-[500px] sm:h-[600px]"
        src={hero}
        alt="pizza, burger, calzone, kebab"
        style={{ objectFit: 'cover' }}
      />

      <div className="absolute inset-0 text-white font-extrabold flex flex-col justify-center items-center">
        <div className="flex flex-col justify-center my-auto px-4 text-hero">
          <h2 className="text-5xl font-extrabold tracking-tight leading-none text-white lg:text-6xl flex justify-start sm:justify-center mb-4">
            Kom tom, gå full!
          </h2>
